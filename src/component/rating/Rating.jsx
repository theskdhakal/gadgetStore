...
const noRateStar=hasDecimalValue >0?maxRateStar-fullRateStar-1:maxRateStar-fullRateStar
...
const noStar=new Array(noRateStar).fill("");
  ...
  return (
    <div className="text-warning d-flex gap-1 justify-content-center align-items-center">
        {fullStar.map(()>(
            <BsStarFill/>
        ))}
